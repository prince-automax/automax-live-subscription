...
export default function Contact() {
  return (
    <div className="max-w-7xl   my-2 sm:mx-auto mx-2  overflow-hidden rounded-xl md:rounded-none   border ">
      ...
      <div className="bg-gradient-to-r from-[#175994] to-[#70BAFC] flex">
      {/* <div className=" w-20  flex justify-center items-center">
            <Link href="/login">
              <p className="text-white  hover:text-indigo-700 hover:underline  rounded-full px-2 py-px">
               Home
              </p>
            </Link>
          </div> */}
        <p className="  justify-center items-center flex font-poppins text-center w-full h-16 font-medium text-xl sm:text-2xl  text-[#FFFFFF] pl-4 ">
          
          <strong className="items-center text-center">
            Terms &amp; Conditions
          </strong>{" "}
        </p>
      </div>
      ...
      <div className="w-full p-2 sm:p-4 text-[12px] sm:text-base  space-y-4 font-roboto ">
        <p className="text-[#717171]">
          By downloading or using the app or website, these terms will
          ...
          related to it, still belong to Automax Solutions India Pvt. Ltd..
          Automax Solutions India Pvt. Ltd. is committed to ensuring that the
        ...
        <p className="text-[#717171]">
          ...
          security features and it could mean that the AutoBSE app won’t work
          properly or at all.
        </p>{" "}
        <div>
          <p className="text-[#717171]">
        ...
        <p className="text-[#717171]">
          You should be aware that there are certain things that Automax
          Solutions India Pvt. Ltd. will not take responsibility for. Certain
          ...
          network provider, but Automax Solutions India Pvt. Ltd. cannot take
        ...
        <p className="text-[#717171]">
          ...
          you can’t turn it on to avail the Service, Automax Solutions India
          Pvt. Ltd. cannot accept responsibility. With respect to Automax
          Solutions India Pvt. Ltd.’s responsibility for your use of the app,
          ...
          that we can make it available to you. Automax Solutions India Pvt.
          Ltd. accepts no liability for any loss, direct or indirect, you
        ...
        <p className="text-[#717171]">
          ...
          the updates if you want to keep using the app. Automax Solutions India
        ...
        <p className="text-[#717171]">
          ...
          Conditions, do not hesitate to contact us at shanidh@autobse.com. This
